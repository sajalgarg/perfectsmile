    ...
    <section id="about-us">
        <div class="container">
			<div class="center wow fadeInDown" style="text-align: justify;">
				...
				<p class="lead" >At Perfect Smile Dental Clinic, we offer an extensive range of services to our patients using the latest technology available in the dental industry today. It is our priority to create a warm, comfortable and welcoming environment for our patients, and deliver minimally invasive treatment with best knowledge and care.
				
				The team at Perfect Smile Dental Clinic includes principal dentist and owner Dr Dimple Verma, with Dr Ashish Verma and a team of experts.
				
				All procedures in the clinic are performed on the basis of modern technology and advanced materials. New tools allow you to minimize the use of traditional drills and other equipment, which previously could cause your fear. We use only the best novelties and try to make a visit to the dentist comfortable and painless for each patient. The professional level of our doctors is confirmed by diplomas, certificates and most importantly skill. 
				...
				At Perfect smile you will find a blend of experienced and young clinicians providing a treatment that includes both wisdom and enthusiasm. 
				</div>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										...
										<li class="btn"><a href="#">Implantologist</a></li>
										<li class="btn"><a href="#">Laser Specialist</a></li>
										<li class="btn"><a href="#">On Panel BHEL</a></li>
									</ul>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										<li class="btn"><a href="#">Professor</a></li>
										<li class="btn"><a href="#">MDS</a></li>
										<li class="btn"><a href="#">Oral and Maxillofacial Surgeon professor</a></li>
										<li class="btn"><a href="#">Laser Specialist</a></li>
									</ul>
									
								</div>
							</div><!--/.media -->
							<p> Dr. Dimple Verma completed her M.D.S. in Oral and Maxillofacial Surgery from renowned DAV Dental College, Yamunanagar in 2007. Her Special interests include Facial Trauma, Oral Cancer Diagnosis and Complex Tooth Extractions.</p>
							...
							<div class="media">
								...
								<div class="media-body">
									...
									<ul class="tag clearfix">
										<li class="btn"><a href="#">MDS</a></li>
										<li class="btn"><a href="#">Professor</a></li>
										<li class="btn"><a href="#">Root Canal Specialist</a></li>
										
									</ul>
									
								</div>
							</div>
							<p>Dr Monika Tandan has done her BDS from Bangalore Institute of Dental Sciences, Bangalore in 2004. She completed her MDS in Conservative Dentistry and Endodontics from A B Shetty  Memorial Institute of Dental Sciences, Mangalore in 2008. </p>
				...
				<div class="row clearfix">
					<div class="col-md-4 col-sm-6">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" style="background-color: white">
							...
							<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModa5" style="background:#c52d2f none repeat scroll 0 0">More..</button>
							</div>
					</div><!--/.col-lg-4 -->
					...
					<div class="col-md-4 col-sm-6 col-md-offset-2">	
						<div class="single-profile-top wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms" style="background-color: white">
							...
							<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal6" style="background:#c52d2f none repeat scroll 0 0">More..</button>
							</div>
					</div><!--/.col-lg-4 -->					
				</div> <!--/.row -->
				<div class="row team-bar">
...
He is a  competent dental professionals with proven clinical & diagnostic abilities & proven competency in dentistry.</p>
							<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal7" style="background:#c52d2f none repeat scroll 0 0">More..</button>
						</div>
					</div>
					<div class="col-md-4 col-sm-6 col-md-offset-2">
						<div class="single-profile-bottom wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="600ms" style="background-color: white">
							...
							<button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal8" style="background:#c52d2f none repeat scroll 0 0">More..</button>
						</div>
					</div>
				</div>	<!--/.row-->
